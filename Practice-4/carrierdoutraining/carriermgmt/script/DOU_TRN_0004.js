...
//        let sXml1 = sheetObjects[0].GetSearchData("DOU_TRN_0004GS.do", sParam1);
//
...
//    }
    ...
    function s_carrier_OnCheckClick(){
    	
    }
    
    function sheetCarrier_OnSaveEnd(){
//    	ComOpenWait(false);
    }
    
    function checkCodeDuplicated(){
...
//    		ComOpenPopup('/opuscntr/COM_ENS_041.do', 800, 500, 'setCustCd', '1,0,1,1,1,1', true);
 ...
 // Event when click on button of combobox
    function s_carrier_OnCheckClick(Index, Code, Checked) {
        //console.log("[Index:]" + Index + "[ Code:]"+ Code + "[Checked:]" + Checked);
