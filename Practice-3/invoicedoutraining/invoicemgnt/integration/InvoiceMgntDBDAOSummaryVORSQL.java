...
*@FileName : InvoiceMgntDBDAOSummaryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceMgntDBDAOSummaryVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceMgntDBDAOSummaryVORSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceMgntDBDAOSummaryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
