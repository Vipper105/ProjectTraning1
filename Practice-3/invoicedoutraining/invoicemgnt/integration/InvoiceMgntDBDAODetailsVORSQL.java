...
*@FileName : InvoiceMgntDBDAODetailsVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceMgntDBDAODetailsVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceMgntDBDAODetailsVORSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceMgntDBDAODetailsVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
