...
*@FileName : CodeMgmtDBDAOCodeMgmtVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtVORSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${intg_cd_nm} != '') " ).append("\n"); 
		query.append("and	UPPER(INTG_CD_NM) like '%'|| UPPER(@[intg_cd_nm])|| '%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
