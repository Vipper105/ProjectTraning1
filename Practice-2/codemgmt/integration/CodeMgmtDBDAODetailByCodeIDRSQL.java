...
*@FileName : CodeMgmtDBDAODetailByCodeIDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAODetailByCodeIDRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAODetailByCodeIDRSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAODetailByCodeIDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("#if (${intg_cd_id} != '') AND INTG_CD_ID LIKE @[intg_cd_id]" ).append("\n"); 
