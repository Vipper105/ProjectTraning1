...
*@FileName : DetailByCodeIDVO.java
*@FileTitle : DetailByCodeIDVO
*Open Issues :
*Change history :
...
public class DetailByCodeIDVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DetailByCodeIDVO> models = new ArrayList<DetailByCodeIDVO>();
	...
	public DetailByCodeIDVO() {}

	public DetailByCodeIDVO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String aplyEndDt, String aplyStDt, String intgCdValDpSeq, String intgCdValDesc, String intgCdValDpDesc, String intgCdValCtnt, String intgCdId) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public DetailByCodeIDVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DetailByCodeIDVO[]
	 */
	public DetailByCodeIDVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DetailByCodeIDVO model = null;
	...
	public DetailByCodeIDVO[] getDetailByCodeIDVOs(){
		DetailByCodeIDVO[] vos = (DetailByCodeIDVO[])models.toArray(new DetailByCodeIDVO[models.size()]);
		return vos;
	}
